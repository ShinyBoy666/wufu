...
class Index {
    ...
    public void index() {
        ...
        try {
            ...
            Directory directory = FSDirectory.open(FileSystems.getDefault().getPath("/Users/tanjiangyong/LuceneDemo/data/index"));
            // 2、创建IndexWriter
            ...
            //要搜索的File路径
            File dFile = new File("/Users/tanjiangyong/LuceneDemo/data/data");
    ...
    public void search(String keyWord) {  
        ...
        try {  
            ...
            for (ScoreDoc scoreDoc : scoreDocs) {  
                ...
                System.out.println(document.get("productName") + " " + document.get("id"));  
            }  
