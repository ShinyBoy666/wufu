 ...
 *
 */
@Component ("cn.xinmeng.web.shop.impl.address.S1060Component")
public class S1060Component extends BaseService{
	...
	public AppResponseEntity callServer(AppRequestEntity request,String data){
		...
		if(address == null){
			...
			//购物车添加商品
			address.setCreateUser("API");
			return getAppResponseEntity(commonAddressService.add(address));
		}
	}
