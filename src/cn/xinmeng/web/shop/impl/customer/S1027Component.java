 ...
 *
 */
@Component ("cn.xinmeng.web.shop.impl.customer.S1027Component")
public class S1027Component extends BaseService {
	...
	public AppResponseEntity callServer(AppRequestEntity request,String data){
		...
		}else if(Utils.isEmpty(entity.getAppVeision())){
			throw new BusinessException(LogManager.getLogger(this.getClass()),ExCustomerEnum.EX_NULL_APP_VERSION_IS);
		}else if(Utils.isEmpty(entity.getSystemVersion())){
			throw new BusinessException(LogManager.getLogger(this.getClass()),ExCustomerEnum.EX_NULL_SYSTEM_VERSION_IS);
		...
		}else if(Utils.isEmpty(entity.getImei())){
			throw new BusinessException(LogManager.getLogger(this.getClass()),ExCustomerEnum.EX_NULL_DEVICE_NUMBER_IS);
