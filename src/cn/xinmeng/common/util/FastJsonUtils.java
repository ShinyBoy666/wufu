...
import cn.xinmeng.common.exceptions.JSONException;
...
public class FastJsonUtils {
	...
	public static String bean2JsonFormat(Object bean){
		...
		try {
			...
			throw new JSONException("实体转JSON异常：", e);
		}
	}
	...
	public static <T> T json2Bean(String jsonStr,Class<T> clazz) {
		...
		try {
			...
			throw new JSONException("JSON转实体异常：", e);
		}
	}
	...
	public static <T> String list2Json(List<T> listBean) {
		...
		try {
			...
			throw new JSONException("List转JSON异常：", e);
		}
	}
