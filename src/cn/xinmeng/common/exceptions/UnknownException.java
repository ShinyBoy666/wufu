 ...
 *
 */
public class UnknownException extends GeneralException implements IException{
	/**
	 * 
	 */
	...
	public <T extends IEnum> UnknownException(Logger log,String msg){
		this(msg);
		if(log != null){
	...
	public UnknownException(String msg,Throwable cause,Map<String, Serializable> data){
		this(msg,cause);
		this.errorData = data;
	}
	
	public <T extends IEnum> UnknownException(Logger log,T ienum){
		super(ienum.value());
		this.key = ienum.key();
		this.value = ienum.value();
		if(log != null){
			log.debug(this.value(),this);
		}
	}
	
	public <T extends IEnum> UnknownException(Logger log,T ienum,Throwable cause){
	...
	public <T extends IEnum> UnknownException(Logger log,T ienum,Map<String, Serializable> data){
		this(log,ienum);
		this.errorData = data;
	}
	
	public <T extends IEnum> UnknownException(Logger log,T ienum,Object... param){
	...
	public UnknownException(Logger log,Throwable cause){
		this(cause);
		if(log != null){
			log.debug(this.getMessage(),this);
		}
