 ...
 * 库存记录状态
 * @param 
 * @ClassName: QuantityChangeTypeEnum 
 * @version V1.0  
 ...
 *
 */
public enum QuantityChangeTypeEnum implements IEnum{
	ADD("1","增加"),
	SUB("2","减少"),
	;
	
	private QuantityChangeTypeEnum(String key,String value){
		this.key = key;
		this.value = value;
	}
	private String key;
	...
	public static boolean exist(String value){
		boolean exist = false;
		for (QuantityChangeTypeEnum type : QuantityChangeTypeEnum.values()) {
	...
	public static String keyToValue(String key){
		for (QuantityChangeTypeEnum item : QuantityChangeTypeEnum.values()) {
